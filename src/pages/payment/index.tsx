...
const PaymentPage = () => {
  ...
  return (
    <div className="mt-24 text-3xl font-semibold">
      <h2 className="mb-10">원하는 멤버십을 선택하세요.</h2>

      <div className="flex flex-col gap-4">
        <div className="flex-1 border-2 border-stone-500 p-4 w-[500px] mt-10 mb-10">
          <div className="mb-4">
            <button
              className="text-white bg-yellow-500 px-4 py-2 rounded"
              onClick={() =>
        ...
        <div className="flex-1 border-2 border-stone-500 p-4 w-[500px]">
          <div className="mb-4">
            <button
              className="text-white bg-pink-500 px-4 py-2 rounded"
              onClick={() =>
                handleClick({
